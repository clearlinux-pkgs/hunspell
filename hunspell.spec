...
Version  : 1.7.2
Release  : 10
URL      : https://github.com/hunspell/hunspell/archive/v1.7.2/hunspell-1.7.2.tar.gz
Source0  : https://github.com/hunspell/hunspell/archive/v1.7.2/hunspell-1.7.2.tar.gz
...
%prep
%setup -q -n hunspell-1.7.2
cd %{_builddir}/hunspell-1.7.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672418057
...
cp %{_builddir}/hunspell-%{version}/license.hunspell %{buildroot}/usr/share/package-licenses/hunspell/f890af19fd4ea29bad829cf45a1689a97b208f75 || :
...
/usr/share/package-licenses/hunspell/f890af19fd4ea29bad829cf45a1689a97b208f75
